...
<div class="nav">
		<ul>
		 <li><a href="admin.html" >HOME</a></li>
		  <li><a href="cdetails.jsp" class="active">CHOREO</a></li>
		  <li><a href="ldetails.jsp">LEARNER</a></li>
    ...
    ResultSet rs=con.createStatement().executeQuery("select * from choreo");
    ...
    <td><a href="del_choreo.jsp?cmail=<%=rs.getString("cmail")%>"><input type="submit" id="submit" value="Delete Choreo"></a></td>
    </tr>
    <% 
    }
    %>
